...
class _AdditionalInfoScreenState extends State<AdditionalInfoScreen> {
          ...
          : GestureDetector(
              ...
              child: Stepper(
                ...
                steps: [
                  ...
                  Step(
                    title: _currentStep == 3 ? Text('Age') : SizedBox.shrink(),
                    content: addAge(),
  ...
  Future<String?> uploadToFirebase() async {
    try {
      ...
      final firebase_storage.Reference ref = firebase_storage
          ...
          .ref()
          .child('userProfileImages/$uid/$imageName');
  ...
  bool isDataCompleted() {
    if (phone != null && _imageFile != null && address != null && age != null) {
      return true;
    } else {
      return false;
    }

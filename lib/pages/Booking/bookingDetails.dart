                ...
                child: Column(
                  ...
                  children: [
                    if (booking.status == Status.active) ...[
                      ...
                      Center(
                        child:
                            Text("Show this QR Code when service is completed"),
                      ),
                      SizedBox(
                        height: 10,
                      ),
                    ...
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 8.0),
                      child: _buildDetail(
                          'Booking ID', booking.id.toString(), width * 4),
                    ),
                    Center(
                      child: Wrap(
                        children: [
                          _buildDetail('Title', booking.title, width),
                          _buildDetail('Booked on', formattedDateTime, width),
                          _buildDetail(
                              'Booking Date', formattedBookingDate, width),
                          _buildDetail('Time Slot', booking.timeSlot, width),
                          _buildDetail(
                              'Price', "\$${booking.total.toString()}", width),
                          FutureBuilder<DocumentSnapshot>(
                            future: FirebaseFirestore.instance
                                .collection('employee')
